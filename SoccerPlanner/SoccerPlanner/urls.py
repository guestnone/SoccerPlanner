...
urlpatterns = [
    ...
    path(
        ...
        views.accountcreatesuccessful,
        name="accountcreatesuccessful",
    ),
    ...
    path(
        "stagecreatesuccessful/",
        views.stagecreatesuccessful,
        name="stagecreatesuccessful",
    ),
    path("tournamentcreate", views.tournamentcreate, name="tournamentcreate"),
    path(
        "stagedeletesuccessful",
        views.stagedeletesuccessful,
        name="stagedeletesuccessful",
    ),
    path("captcha", views.captcha, name="captcha"),
    path("stageeditsuccessful", views.stageeditsuccessful, name="stageeditsuccessful"),
    path(
        "account/passwordreset/",
        PasswordResetView.as_view(template_name="app/passwordreset.html"),
        name="passwordreset",
    ),
    path(
        "account/passwordresetdone/",
        PasswordResetDoneView.as_view(template_name="app/passwordresetdone.html"),
        name="password_reset_done",
    ),
    path(
        "account/reset/<uidb64>/<token>/",
        PasswordResetConfirmView.as_view(template_name="app/passwordresetconfirm.html"),
        name="password_reset_confirm",
    ),
    path(
        "account/resetlogged/",
        PasswordChangeView.as_view(template_name="app/passwordresetconfirmlogged.html"),
        name="password_reset_confirm_logged",
    ),
    path(
        "account/resetloggeddone/",
        PasswordChangeDoneView.as_view(
            template_name="app/passwordresetloggeddone.html"
        ),
